...
def exit_handler(signal, frame):
    ...
    print(Fore.RED + 'Ok, bye!' + Fore.RESET )
    sys.exit(0)
...
def main(token):
    ...
    By: {Fore.RED + 'PR3C14D0 & K3KK3R'}

    {Fore.BLUE + 'For educational purposes only'}
    ...
    opt = input(Fore.YELLOW + 'root@assfvcker:~# ' + Fore.RESET)
...
def tokenFvcker(userData, token):
    invite = input(Fore.GREEN + 'Server invite (your server without discord.gg): ' + Fore.RESET)
...
if __name__ == '__main__':
    os.system('title A$$Masher by: PR3C14D0 and K3KK3R' if os.name == 'nt' else '')
    os.system('cls' if os.name == 'nt' else 'clear')
